    ...
    <div className="w-full px-2">
      <div className="relative flex h-[400px] md:h-[600px] lg:h-[900px] xl:h-[900px] 2xl:h-[1000px] min-w-full items-end justify-center lg:items-center lg:justify-start">
        ...
        <Image
          ...
          width={1200}
          height={1200}
          className="absolute top-0 lg:right-0 w-[500px] h-[500px] md:w-[600px] md:h-[700px] lg:w-[700px] lg:h-[900px] xl:w-[900px] xl:h-[900px] 2xl:w-[1000px] 2xl:h-[1000px] object-cover transition-all duration-500 grayscale hover:grayscale-0 brightness-50 hover:brightness-100"
        />
      </div>
    </div>
  );
